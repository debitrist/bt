...
class MovingAverageCrossStrategy(Strategy):
    ...
    def generate_signals(self):
        ...
        # respective periods
        signals['short_mavg'] = pd.Series(bars['Close'].rolling(self.short_window, min_periods=1).mean())
        signals['long_mavg'] = pd.Series(bars['Close'].rolling(self.long_window, min_periods=1).mean())
